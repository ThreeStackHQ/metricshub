...
function Sidebar({ mobile, onClose }: { mobile?: boolean; onClose?: () => void }) {
  ...
  return (
    <aside
      className={`flex flex-col h-full bg-[#161b22] border-r border-[#30363d] ${
        mobile ? "w-full" : "w-60"
      }`}
    >
      {/* Logo */}
    ...
    <div className="flex h-screen bg-[#0d1117] overflow-hidden">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          />
          <div className="relative flex flex-col w-72 bg-[#161b22] z-10">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Header */}
        <header className="h-16 flex items-center justify-between px-4 md:px-6 border-b border-[#30363d] bg-[#161b22] flex-shrink-0">
          <div className="flex items-center gap-3">
            {/* Mobile hamburger */}
            <button
            ...
            <nav className="flex items-center gap-2 text-sm">
              <span className="text-gray-500">MetricsHub</span>
